...
{
    public class SupportQcProblemBusinnessRule
    {
        ...
        public static readonly BusinessRule FiscallConfillictRequired = new BusinessRule("FiscallConfillict", "مقایرت مالی باید وارد شود");
